...
for line in sys.stdin:
    ...
    # Convertimos el número de ocurrencias a entero
    try:
        count = int(count)
    except ValueError:
        # Error al convertir a entero
        # Se descarta la línea silenciosamente
        continue
    ...
    if current_word == word:
        ...
        # Hack para controlar el caso de la primera línea
        if current_word:
...
# ¡No hay que olvidar la última entrada!
if current_word == word:
    print '%s\t%s' % (current_word, current_count)